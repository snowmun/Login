...
//hacer listado de todos los usuarios
$dato="select * from usuarios";
$result = $conexion->query($dato);
?>
<!DOCTYPE html>
<html lang="en">
  ...
  <div class="container  ">
    <div class="row">
      <nav class="navbar navbar-expand-lg  navbar-dark bg-dark ">
        <a class="navbar-brand" href="home.php">Bienvenido</a><?php echo $id['nombre'] ?>
          ...
          ?>
            <tr>
              ...
              <td>
                ...
                <a href="../controller/eliminar.php?id=<?php echo $filas['id'] ?>">eliminar</a>
              </td>
            </tr>
          <?php } ?>
